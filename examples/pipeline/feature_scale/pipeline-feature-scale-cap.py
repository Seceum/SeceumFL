...
def main(config="../../config.yaml", namespace=""):
    ...
    #                                feat_upper=[10, 8], feat_lower=[1.2, 0.1], scale_names=["x1", "x4"])
    # standard scale ok
    # feature_scale_0 = FeatureScale(name="feature_scale_0",method="standard_scale",mode="normal",
    #                                feat_upper=10,feat_lower=1.2)
    # ok
    feature_scale_0 = FeatureScale(name="feature_scale_0", method="standard_scale", mode="normal",
                                   # ,
                                   # feat_upper=[10,8], feat_lower=[1.2,0.1],
                                   scale_names=["x1","x4"]
                                   )
    statistic_param = {
        "name": "statistic_0",
    ...
    statictis_0 = DataStatistics(**statistic_param)
    ...
    pipeline.add_component(statictis_0,data=Data(data=feature_scale_0.output.data))
