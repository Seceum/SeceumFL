...
def split(jobid):
    global COMMON_PARAM,SPLIT_COMMON
    wrapper.t_(jobid,MODULE,common_param=COMMON_PARAM,split_param=SPLIT_COMMON,cpn="scale_0")

def split_and_eval(jobid):
    global COMMON_PARAM,EVAL_PARAM,SPLIT_COMMON
    wrapper.t_(jobid,MODULE,common_param=COMMON_PARAM,split_param=SPLIT_COMMON,eva_param=EVAL_PARAM,cpn="scale_0")
