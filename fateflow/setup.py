...
# v1.4.3 编译py清单
# psi ok
psi=['python/federatedml/transfer_variable/transfer_class/bark_oprf_transfer_variable.py',
            'python/federatedml/statistic/intersect/bark_oprf_intersect/bark_oprf_intersect_guest.py',
            'python/federatedml/statistic/intersect/bark_oprf_intersect/bark_oprf_intersect_host.py']



#home xgboost ok
xgboost=[
# 'python/federatedml/components/hetero_xgboost.py',
        # 'python/federatedml/components/homo_xgboost.py',
        # 'python/federatedml/ensemble/boosting/hetero/hetero_xgboost_host.py',
        'python/federatedml/ensemble/boosting/homo/homo_xgboost_arbiter.py',
    
        # 'python/federatedml/ensemble/boosting/hetero/hetero_xgboost_guest.py',
        # 'python/federatedml/ensemble/boosting/homo/homo_xgboost_client.py',
        # 'python/federatedml/param/hetero_xgboost_param.py',
        # 'python/federatedml/param/homo_xgboost_param.py',
        # 'python/federatedml/transfer_variable/transfer_class/hetero_xgboost_predict_transfer_variable.py'
         ]

lightgbm=[
    # 'python/federatedml/components/hetero_lightGBM.py',
    #         'python/federatedml/ensemble/basic_algorithms/decision_tree/hetero/hetero_lightGBM_decision_tree_guest.py',
    #         'python/federatedml/ensemble/basic_algorithms/decision_tree/hetero/hetero_lightGBM_decision_tree_host.py',
            'python/federatedml/ensemble/boosting/hetero/hetero_lightGBM_guest.py',
            'python/federatedml/ensemble/boosting/hetero/hetero_lightGBM_host.py',
            'python/federatedml/ensemble/boosting/hetero/hetero_lightGBM_plan.py',
            # 'python/federatedml/param/hetero_lightGBM_param.py',
            # 'python/federatedml/transfer_variable/transfer_class/hetero_lightGBM_predict_transfer_variable.py'
]

block=['python/fate_flow/web_server/blocks/components/component.py'
    ...
    # ,'python/fate_flow/web_server/blocks/block.py'
    ,'python/fate_flow/web_server/blocks/consts.py'
    ,'python/fate_flow/web_server/blocks/dummy.py',
       'python/fate_flow/web_server/blocks/evaluation.py',
       'python/fate_flow/web_server/blocks/feature_binning.py'
    ,'python/fate_flow/web_server/blocks/feature_selection.py'
    ,'python/fate_flow/web_server/blocks/fusion.py'
    ,'python/fate_flow/web_server/blocks/group.py'
    ,'python/fate_flow/web_server/blocks/job_config.py'
    ,'python/fate_flow/web_server/blocks/preprocess.py'
    # ,'python/fate_flow/web_server/blocks/sample.py'
...
report=['python/fate_flow/web_server/report/fl_report_data/clustering.py',
        # 'python/fate_flow/web_server/report/fl_report_data/curves.py',
        ...
        # 'python/fate_flow/web_server/report/graph/curves.py',
        # 'python/fate_flow/web_server/report/graph/cv_curves.py',
        # 'python/fate_flow/web_server/report/graph/loss_curve.py',
        ...
        'python/fate_flow/web_server/report/collector.py',
        'python/fate_flow/web_server/report/component.py',
        'python/fate_flow/web_server/report/content.py',
        'python/fate_flow/web_server/report/converter.py',
...
# websocket=['python/fate_flow/web_server/websocket/log_socket.py']
