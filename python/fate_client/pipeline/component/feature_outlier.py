...
from pipeline.param.feature_outlier_param import FeatureOutlierParam
...
class FeatureOutlier(FateComponent, FeatureOutlierParam):
    def __init__(self, **kwargs):
        ...
        FeatureOutlierParam.__init__(self, **new_kwargs)
        self.input = Input(self.name)
        self.output = Output(self.name, has_model=True)
        self._module_name = "FeatureOutlier"
