...
class SecureInformationRetrievalParam(BaseParam):
    ...
    # add by tjx 2022616
    target_ids: str or list of str
        target ids to retrieve
        target_ids not None
    ...
    def __init__(self, security_level=0.5,
        ...
        self.target_ids = [] if target_ids is None else target_ids
    ...
    def check(self):
        ...
        if len(self.target_ids) == 0:
            raise ValueError("f target ids are empty, target ids should not empty")
