...
from fate_arch.common.address import StandaloneAddress, EggRollAddress, HDFSAddress, \
    MysqlAddress, \
    PathAddress, LocalFSAddress, HiveAddress, LinkisHiveAddress, ApiAddress, OracleAddress, HBASEAddress,PostgresqlAddress
...
class Relationship(object):
    ...
    EngineToAddress = {
        ...
        StorageEngine.HBASE: HBASEAddress,
        StorageEngine.ORACLE: OracleAddress,
        StorageEngine.POSTGRESQL: PostgresqlAddress,
        StorageEngine.FLHIVE: HiveAddress
    }
