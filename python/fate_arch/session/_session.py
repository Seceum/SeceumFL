...
class Session(object):
    ...
    def _get_or_create_storage(self,
        ...
        elif storage_engine == StorageEngine.ORACLE:
            from fate_arch.storage.oracle import StorageSession
            storage_session = StorageSession(session_id=storage_session_id, options=kwargs.get("options", {}))
        ...
        elif storage_engine == StorageEngine.FLHIVE:
            from fate_arch.storage.fl_hive import StorageSession
            storage_session = StorageSession(session_id=storage_session_id, options=kwargs.get("options", {}))
        elif storage_engine == StorageEngine.POSTGRESQL:
            from fate_arch.storage.postgresql import StorageSession
            storage_session = StorageSession(session_id=storage_session_id, options=kwargs.get("options", {}))
        elif storage_engine == StorageEngine.HBASE:
            from fate_arch.storage.hbase import StorageSession
            storage_session = StorageSession(session_id=storage_session_id, options=kwargs.get("options", {}))
