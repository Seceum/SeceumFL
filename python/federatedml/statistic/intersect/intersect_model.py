...
# add by tjx 20220221
from federatedml.statistic.intersect.bark_oprf_intersect.bark_oprf_intersect_guest import BaRK_OPRF_IntersectGuest
from federatedml.statistic.intersect.bark_oprf_intersect.bark_oprf_intersect_host import BaRK_OPRF_IntersectHost
...
class IntersectHost(IntersectModelBase):
    ...
    def init_intersect_method(self):
        ...
        # add by tjx 20220221 bark-oprf
        elif self.intersect_method == consts.BaRK_OPRF:
            self.intersection_obj = BaRK_OPRF_IntersectHost()
        else:
...
class IntersectGuest(IntersectModelBase):
    ...
    def init_intersect_method(self):
        ...
        # add by tjx 20220221 bark-oprf
            ...
            self.intersection_obj = BaRK_OPRF_IntersectGuest()
        else:
            raise ValueError("intersect_method {} is not support yet".format(self.intersect_method))
