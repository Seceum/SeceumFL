    ...
    def fit_single_model(self, data_instances, validate_data=None):
        ...
        with SPDZ(
            ...
            while self.n_iter_ < self.max_iter:
                if self.model_param.reveal_strategy != "encrypted_reveal_in_host": self.callback_list.on_epoch_begin(self.n_iter_)
                ...
                if self.model_param.reveal_strategy != "encrypted_reveal_in_host": self.callback_list.on_epoch_end(self.n_iter_)
                self.n_iter_ += 1
