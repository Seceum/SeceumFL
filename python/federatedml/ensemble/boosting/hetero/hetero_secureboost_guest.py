        ...
        for id_ in feature_importances:
            ...
            if type(id_) == tuple:
                if consts.GUEST in id_[0]:
                    ...
                    new_fi[Anonymous.generate_anonymous_column(role=role, suf=id_[1], party_id=party_id)] = feature_importances[id_].importance
            else:
    ...
    def get_model_param(self):
        ...
        for (sitename, fid), importance in feature_importances:
            if consts.GUEST in sitename:
                ...
                fullname = Anonymous.generate_anonymous_column(suf=fid, party_id=party_id, role=role_name)
