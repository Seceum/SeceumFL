...
class HeteroXGBoostHost(HeteroBoostingHost):

    def __init__(self):
        super(HeteroXGBoostHost, self).__init__()
    ...
    def _init_model(self, param: HeteroXGBoostParam):
        ...
        super(HeteroXGBoostHost, self)._init_model(param)
    ...
    def traverse_trees(leaf_pos, sample, trees: List[HeteroDecisionTreeHost]):
        ...
        for t_idx, tree in enumerate(trees):
            ...
            if cur_node_idx == -1:
                continue
            nid, _ = HeteroXGBoostHost.traverse_a_tree(tree, sample, cur_node_idx)
    ...
    def get_model_meta(self):
        ...
        # meta_name = "HeteroXGBoostHostModelMeta"
        meta_name = "HeteroXGBoostHostMeta"
    ...
    def get_model_param(self):
        ...
        for fid, name in self.feature_name_fid_mapping.items():
            anonymous_name_mapping[Anonymous.generate_anonymous_column(suf=fid, role=consts.HOST, party_id=party_id,)] = name
        ...
        param_name = "HeteroXGBoostHostParam"
        # update by tjx 2023314
        # param_name = "HeteroXGBoostHostModelParam"
