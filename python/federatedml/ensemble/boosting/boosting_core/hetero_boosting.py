...
class HeteroBoosting(Boosting, ABC):
    ...
    def __init__(self):
        ...
        self.host_feature_id_mapping = None
...
class HeteroBoostingGuest(HeteroBoosting, ABC):
    ...
    def sync_stop_flag(self, stop_flag, num_round):
        ...
        self.transfer_variable.stop_flag.remote(stop_flag,
                                                ...
                                                idx=-1,
                                                suffix=(num_round,))
    def get_host_feature_id_mapping(self):
        return self.transfer_variable.feature_name_id_mapping.get(idx=-1)
    ...
    def fit(self, data_inst, validate_data=None):
        ...
        self.host_feature_id_mapping = self.get_host_feature_id_mapping()
...
class HeteroBoostingHost(HeteroBoosting, ABC):
    ...
    def send_feature_id_mapping(self):
        self.transfer_variable.feature_name_id_mapping.remote({config.local_party_id:self.host_feature_id_mapping},role=consts.GUEST,idx=0)
    ...
    def fit(self, data_inst, validate_data=None):
        ...
        # add by tjx 202362
        self.host_feature_id_mapping = self.gen_feature_fid_mapping(data_inst.schema)

        self.send_feature_id_mapping()
        self.sync_booster_dim()
        self.generate_encrypter()
        self.callback_list.on_train_begin(data_inst, validate_data)
