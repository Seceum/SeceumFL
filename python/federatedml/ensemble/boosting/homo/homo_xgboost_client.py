...
class HomoXGBoostingTreeClient(HomoBoostingClient):

    def __init__(self):
        super(HomoXGBoostingTreeClient, self).__init__()
    ...
    def _init_model(self, boosting_param: HomoXGBoostParam):
        ...
        super(HomoXGBoostingTreeClient, self)._init_model(boosting_param)
    ...
    def get_model_param(self):
        ...
        param_name = "HomoXGBoostingTreeGuestParam"
    ...
    def get_model_meta(self):
        ...
        meta_name = "HomoXGBoostingTreeGuestMeta"
