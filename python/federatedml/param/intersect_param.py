...
class ECDHParam(BaseParam):
    ...
    curve: str
        ...
        now add curvesm2 by tjx 202355
    """
    ...
    def check(self):
        ...
        self.curve = self.check_and_change_lower(self.curve, [consts.CURVE25519,consts.CURVESM2], f"{descr}curve")
...
class IntersectParam(BaseParam):
    ...
    intersect_method: str
        ...
        at 20220222 add bark-oprf method by tjx
    random_bit: positive int
        it will define the size of blinding factor in rsa algorithm, default 128
    ...
    add by tjx 20220222
    bark_oprf_params:BaRK_OPRFParam
        effective for bark oprf method only
    ...
    def __init__(self, intersect_method: str = consts.RSA, random_bit=DEFAULT_RANDOM_BIT, sync_intersect_ids=True,
                 ...
                 raw_params=RAWParam(), rsa_params=RSAParam(), dh_params=DHParam(), ecdh_params=ECDHParam(),bark_oprf_params=BaRK_OPRFParam(),
        ...
        # add by tjx 20220222
        self.bark_oprf_params = copy.deepcopy(bark_oprf_params)
    ...
    def check(self):
        ...
        # update by tjx 20220223
        self.intersect_method = self.check_and_change_lower(self.intersect_method,
                                                            [consts.RSA, consts.RAW, consts.DH, consts.ECDH,consts.BaRK_OPRF],
