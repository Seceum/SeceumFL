    ...
    def _init_select_params(self, data_instances):
        ...
        if self.header is not None:
            ...
            if self.anonymous_header is None:
                ...
                # 删除host方匿名化 update by tjx 2023525
                data_anonymous_header = self.header
    ...
    def fit(self, data_instances):
        ...
        if len(self.curt_select_properties.select_col_indexes) == 0:
            ...
            LOGGER.warning("None of columns has been set to select, "
                            ...
                            "but be aware that this may lead to unexpected behavior. Header:{}. Random select: {}".format(header, self.curt_select_properties.select_col_names))
            empty_cols = True
