...
def save_feature_imputer_model(missing_fill=False,
    ...
    if missing_fill:
        ...
        if missing_fill_value is not None and header is not None:
            ...
            for c in skip_cols:
                if c in model_param.missing_replace_value:
                    del model_param.missing_replace_value[c]
            ...
            for c in skip_cols:
                if c in model_param.missing_replace_value_type:
                    del model_param.missing_replace_value_type[c]
