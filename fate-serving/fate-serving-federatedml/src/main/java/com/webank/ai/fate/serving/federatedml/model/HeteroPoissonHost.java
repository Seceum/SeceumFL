...
public class HeteroPoissonHost extends HeteroPoisson implements Returnable {

    private static final Logger logger = LoggerFactory.getLogger(HeteroPoissonHost.class);
