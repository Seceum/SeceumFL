...
public class HeteroXGBoostHost extends HeteroSecureBoost implements LocalInferenceAware, Returnable {
    private final String role = "host";
    private final String modelId = "HeteroXGBoostHost"; // need to change
