...
快速入门
==================
`部署安装 <https://github.com/Seceum/SeceumFL/blob/main/%E9%83%A8%E7%BD%B2%E8%AF%B4%E6%98%8E%E6%96%87%E6%A1%A3.md>`_ 
^^^^^^^^^^^^^
...
登录后首先需查看**合作节点是否已经登记**在系统中，请进入**系统管理&rarr;节点管理**查看，然后点击列表中的**测试**，如下图：  
...
.. hint:: 测试数据可以用系统自带的 `examples<https://github.com/Seceum/SeceumFL/tree/main/examples/data>`__ 里面的csv。    
